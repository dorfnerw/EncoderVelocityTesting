...
class CEncoderVelocityTestingCtrl : public ITcOCFCtrlImpl<CEncoderVelocityTestingCtrl, CEncoderVelocityTestingClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("EncoderVelocityTesting: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CEncoderVelocityTestingCtrl>;
